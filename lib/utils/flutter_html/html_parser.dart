...
class HtmlParser extends StatelessWidget {
  ...
  static StyledElement lexDomTree(dom.Document html, List<String> customRenderTags, List<String> blacklistedElements, String cookie) {
    ...
    html.nodes.forEach((node) {
      tree.children.add(_recursiveLexer(node, customRenderTags, blacklistedElements, cookie));
    });
  ...
  static StyledElement _recursiveLexer(dom.Node node, List<String> customRenderTags, List<String> blacklistedElements, String cookie) {
    List<StyledElement> children = List<StyledElement>();

    node.nodes.forEach((childNode) {
      children.add(_recursiveLexer(childNode, customRenderTags, blacklistedElements, cookie));
    });
    ...
    if (node is dom.Element) {
      ...
      if (STYLED_ELEMENTS.contains(node.localName)) {
        ...
        return parseReplacedElement(node, cookie);
