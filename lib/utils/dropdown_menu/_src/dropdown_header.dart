...
typedef String GetItemLabel(String data);

String defaultGetItemLabel(data) {
  if (data is String)
    return data;
  else
    return data.name;
...
class DropdownHeader extends DropdownWidget {
  ...
  DropdownHeader({@required this.titles, this.activeIndex, DropdownMenuController controller, this.onTap, Key key, this.height: 46.0, GetItemLabel getItemLabel})
    ...
    return new GestureDetector(
      ...
      child: new Padding(
          ...
          child: new DecoratedBox(
              decoration: new BoxDecoration(border: new Border(left: Divider.createBorderSide(context))),
              child: new Center(
      ...
      case DropdownEvent.SELECT:
        {
          ...
          setState(() {
            _activeIndex = null;
            String label = controller.data.name;
